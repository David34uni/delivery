...
public class ListenerButton {
    ...
    ListenerButton(){
        ...
        tx_lat= new JLabel("Latitud:");
        tx_long= new JLabel("Logitud:");
        tx_nombre = new JLabel("Nombre:");
        tx_primer_apellido = new JLabel("Primer apellido:");
        ...
        tx_Mensaje = new JLabel("HOLA MUNDO");
        h = new JLabel("");
        ...
        f_prinsipal = new JFrame("Principal");
        btn_aceptar_registro.setBounds(350, 200, 80, 20);
        btn_cancelar_registro.setBounds(350, 230, 80, 20);
        btn_aceptar_ubicacion.setBounds(350, 200, 80, 20);
        btn_cancelar_ubicacion.setBounds(350, 230, 80, 20);
        btn_atras_ubicacion.setBounds(350, 260, 80, 20);
        tf_nombre.setBounds(140, 20, 180, 20);               tx_nombre.setBounds(20, 20, 140, 20);
        ...
        tf_email.setBounds(140, 110, 180, 20);               tx_email.setBounds(20, 110, 140, 20);
        ...
        f_registro.add(h);
        f_ubicacion.add(btn_aceptar_ubicacion);
        ...
        btn_aceptar_registro.addActionListener(new ActionListener(){
            @Override
        ...
        btn_aceptar_ubicacion.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
